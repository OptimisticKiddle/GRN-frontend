      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <div class="col-md-8" data-plugin-portlet>
            <!-- 表格展示 -->
            <el-table :data="tableData" border stripe table-layout="auto" :cell-style="{ padding: '0px' }" ref="multipleTable" highlight-current-row
              ...
              <el-table-column prop="protection_score_treat" label="Protection Score Treat" :sortable="'custom'"
                align="center" width="120px" />
              <el-table-column prop="tc_ctrl" label="TC Ctrl" :sortable="'custom'" align="center" width="120px" />
        ...
        <el-collapse-item name="2">
          ...
          <section class="col-md-6  panel panel-tertiary" data-portlet-item>
            <header class="panel-heading" style="position: relative;">
              ...
              <sup><span data-html="true" data-toggle="tooltip" data-placement="right"
                  title="TF kinetic activity was shown between the two types of cells (ctrl, treat)"><i
                    class="ti-info-alt" style="font-size: 70%"> </i>
                </span></sup>
          ...
          <section class="col-md-6  panel panel-tertiary" data-portlet-item>
            <header class="panel-heading" style="position: relative;">
              ...
              <sup><span data-html="true" data-toggle="tooltip" data-placement="right"
                  title="Marked tf with significant change in activity score (p < 0.05)"><i
                    class="ti-info-alt" style="font-size: 70%"> </i>
                </span></sup>
        ...
        <el-collapse-item name="3">
          ...
          <section class="col-md-4  panel panel-tertiary" id="tutorial-panel-1" data-portlet-item>
            <header class="panel-heading" style="position: relative;">
              ...
              <sup><span data-html="true" data-toggle="tooltip" data-placement="right"
                  title="Draw a STRING network image of footprint related proteins."><i
                    class="ti-info-alt" style="font-size: 70%"> </i>
                </span></sup>
